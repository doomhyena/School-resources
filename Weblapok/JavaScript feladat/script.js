        ...
        while (
          ...
          if (
            ...
            arr[k + 1].innerHTML =
              parseInt(arr[k + 1].innerHTML) + parseInt(arr[k].innerHTML);
            pontok.innerHTML =
              parseInt(arr[k + 1].innerHTML) + parseInt(pontok.innerHTML);
            arr[k].innerHTML = "";
            can = true;
            hozzafer = true;
          } else if (
      ...
      if (arr[j].innerHTML !== "") {
        ...
        while (
          ...
          if (
            ...
            hozzafer = true;
            pontok.innerHTML =
              parseInt(arr[k + 4].innerHTML) + parseInt(pontok.innerHTML);
          } else if (
            parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) &&
            hozzafer === true
          ) {
...
function end() {
  alert(
    "A pontszámod:" + document.getElementById("pontok").innerHTML + " Vége a játéknak"
  );
  ujrarak();
}
...
function szunetel() {
  var szunetel = document.getElementById("szunetel");
  szunetel.style.display = "block";
  var control = document.getElementById("control");
  control.style.display = "none";
}
function ujrarak() {
  var szunetel = document.getElementById("szunetel");
  szunetel.style.display = "none";
  init();
}
function start() {
  var splash = document.getElementById("splash");
  var jatek = document.getElementById("jatek");
