    ...
    <head>
        ...
        <title>Kiadáskövető - Reportok</title>
    ...
    <body>
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="add_expense.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> Kiaás hozzáadása</a>
            ...
            <a href="expensereport.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="file-text"></span> Kiadás Report</a>
    ...
    <h2 class="try">Kiadás Report</h2>
        ...
        <label for="report_type" class="col-sm-6 col-form-label"><b>Report ideje:</b></label>
        <div class="col-md-6">
            <select class="form-control col-sm-12" id="report_type" name="report_type">
                <option value="datewise">Napi Report</option>
                <option value="monthwise">Havi Report</option>
                <option value="yearwise">Éves Report</option>
            </select>
        </div>
    </div>
        ...
        <label for="start_date" class="col-sm-6 col-form-label"><b>Kezdés</b></label>
        <div class="col-md-6">
            <input type="date" class="form-control col-sm-12" value="<?php echo date('Y-m-d'); ?>" name="start_date" id="start_date" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="end_date" class="col-sm-6 col-form-label"><b>Végdátum</b></label>
        <div class="col-md-6">
    ...
    <div class="form-group row">
        ...
        <button type="submit" class="btn btn-lg btn-block btn-success" style="border-radius: 0%;">Report létrehozása</button>
        </div>
    </div>
