...
public partial class NW_2025Ctx : DbContext
{
    public NW_2025Ctx()
    {
    }

    public NW_2025Ctx(DbContextOptions<NW_2025Ctx> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=mssql.scholaeu.hu,36736;Initial Catalog=NorthWind_2025;Persist Security Info=True;User ID=scholadbuser;Password=Schola_Europa_2024;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Authentication>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Authenti__3214EC077490106F");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.Authentications)
                ...
                .HasConstraintName("FK_Authentications_ToEmployee");
        });
