...
if (isset($_POST['update'])) {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "Sikertelen rögzítés $sql. " . mysqli_error($con);
    }
...
<body>
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_expense.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="plus-square"></span> Kiadás hozzáadása</a>
    ...
    <h3 class="try">Adj hozzá egy kiadást</h3>
</div>
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row" style="margin-top: 20px;">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Összeg</b></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="expensedate" class="col-sm-6 col-form-label"><b>Dátum</b></label>
                                <div class="col-md-6">
...
<fieldset class="form-group">
    <div class="row">
        <label class="col-form-label col-sm-6 pt-0"><b>Kategória</b></label>
        <div class="col-md">
                ...
                ?>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    <?php if ($update == true) : ?>
                                        <button class="btn btn-lg btn-block btn-warning" style="border-radius: 0%;" type="submit" name="update">Frissít</button>
                                    <?php elseif ($del == true) : ?>
                                        <button class="btn btn-lg btn-block btn-danger" style="border-radius: 0%;" type="submit" name="delete">Töröl</button>
                                    <?php else : ?>
                                        <button type="submit" name="add" class="btn btn-lg btn-block btn-success" style="border-radius: 0%;">Hozzáad</button>
                                    <?php endif ?>
                                </div>
                            </div>
                        </form>
