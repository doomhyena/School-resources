...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="sidebar-heading">Menedzsment</div>
      <div class="list-group list-group-flush">
        ...
        <a href="manage_expense.php" class="list-group-item list-group-item-action "><span data-feather="dollar-sign"></span> Kiadások kezelése</a>
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="logout.php" class="list-group-item list-group-item-action "><span data-feather="power"></span> Kilépés</a>
      </div>
    </div>
    ...
    <h3 class="try">Főoldal</h3>
</div>
        
      </nav>
      <div class="container-fluid">
        <h4 class="mt-4">TEljes kiadási report</h4>
        <div class="row">
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Mai kiadások</h5>
          <p class="card-text">HUF<?php echo $today_expense_amount; ?></p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Tegnapi kiadások</h5>
          <p class="card-text">HUF<?php echo $yesterday_expense_amount; ?></p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Utóbbi hét kiadásai</h5>
          <p class="card-text">HUF<?php echo $this_week_expense_amount; ?></p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Utóbbi hónap kidásai</h5>
          <p class="card-text">HUF<?php echo $this_month_expense_amount; ?></p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Idei kiadások</h5>
          <p class="card-text">HUF<?php echo $this_year_expense_amount; ?></p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Minden kiadás</h5>
          <p class="card-text">HUF<?php echo $total_expense_amount; ?></p>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Napi kiadások</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Kiadás katgóriája</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Havi kiadások</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Éves kiadások</h5>
              </div>
              <div class="card-body">
...
var dataset = {
    labels: categories,
    datasets: [{
        label: 'Kiadás katgóriája (utóbbi hó)',
        data: expenses,
