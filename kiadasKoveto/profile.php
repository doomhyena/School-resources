...
if (isset($_POST['save'])) {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "Hiba történt. $sql. " . mysqli_error($con);
    }
...
<body>
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="profile.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="user"></span> Profil</a>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light  border-bottom">
                ...
                <h3 class="try">Profil módosítása</h3>
                </div>                
            </nav>
                    ...
                    <div class="col-md-6">
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Vezetéknév" value="<?php echo $firstname; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $lastname; ?>" placeholder="Keresztnév">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0%;" name="save" type="submit">Mentés</button>
                                </div>
                            </div>
                        </form>
