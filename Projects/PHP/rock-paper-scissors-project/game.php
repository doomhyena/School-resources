...
<html>
   ...
   <nav>
		<ul>
			...
			<li><a href="search.php">Felhasználó keresése</a></li>
    ...
    <form method="post">
        ...
        <input type="text" name="opponent_username" id="username-search" placeholder="Írd be a felhasználó nevét!" required>
